...
export const WORK_DESCRIPTIONS = {
  ...
  tapp: {
    ...
    involvementSummary: `Led the development of a sports tech platform with a web & mobile app, robust API, and a data engine, while also managing UX design, development sprints, and user interviews.`,
  },
};
